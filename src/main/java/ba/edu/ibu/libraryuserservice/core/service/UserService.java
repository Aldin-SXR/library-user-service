...
import ba.edu.ibu.libraryuserservice.core.api.mailsender.MailSender;
...
import ba.edu.ibu.libraryuserservice.rest.feign.BookInterface;
...
//    private MailSender mailSender;
    ...
    public UserService(UserRepository userRepository, BookInterface bookInterface) {
    ...
    public List<Book> getBooksByUser(String userId) {
        ...
        for (String id: borrowedBookIds) {
            Book book = bookInterface.getBookById(id).getBody();
            books.add(book);
        }
        return books;
    }
